  ...
  useEffect(() => {
    ...
    if (oauthDebug) {
      try {
        ...
        localStorage.setItem('nav_debug_pop', 'true')
      } catch (e) {
        // Debug info parsing failed
      }
    }
    ...
    if (authResult) {
      try {
        ...
        // Auth result parsing failed
      }
    }

    // Auto-clear debug info after 60 seconds
    if (debugInfo) {
      setTimeout(() => {
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
          ...
          {debugInfo && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <h3 className="text-sm font-medium text-blue-800 mb-2">OAuth Debug Info:</h3>
