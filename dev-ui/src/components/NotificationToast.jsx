...
const NotificationToast = ({
  ...
  return (
    <div className="w-full max-w-[600px]" style={{ minWidth: '480px' }}>
      <div
        className={`w-full shadow-lg rounded-lg pointer-events-auto border ${getBackgroundColor()} transition-all duration-300 transform bg-opacity-95 backdrop-blur-sm ${
