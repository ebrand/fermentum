...
public class CreateAccountWithTenantRequest
{
    public string? OAuthToken { get; set; } // Optional - for OAuth flow
    public UserDataRequest? UserData { get; set; } // Optional - for manual profile creation
    public TenantDataRequest TenantData { get; set; } = new();
    public PaymentDataRequest? PaymentData { get; set; }
}
...
public class UserDataRequest
{
    ...
    public string FirstName { get; set; } = string.Empty;
    public string LastName { get; set; } = string.Empty;
    public string? Password { get; set; } // Required for manual profile creation
}
...
// Payment-gated registration DTOs
public class PaymentGatedRegistrationRequest
{
    public UserProfileData Profile { get; set; } = new();
    public PaymentData Payment { get; set; } = new();
    public TenantData Tenant { get; set; } = new();
}
...
public class PaymentGatedRegistrationResponse
{
    public string AccessToken { get; set; } = string.Empty;
    public string RefreshToken { get; set; } = string.Empty;
    public DateTime ExpiresAt { get; set; }
...
// QuickBooks OAuth DTOs
public class QuickBooksOAuthCallbackRequest
{
