-- Migration: Link recipes to raw materials (corrected schema)
-- Date: 2025-01-27
-- Description: Creates recipe ingredient linkages using the correct RawMaterial table schema
...
BEGIN
    ...
    INSERT INTO "RecipeGrain" ("RecipeId", "MaterialId", "Amount", "Unit", "SortOrder")
    SELECT
    ...
    INSERT INTO "RecipeHop" ("RecipeId", "MaterialId", "Amount", "Unit", "AdditionTime", "AdditionType", "SortOrder")
    SELECT
        '11111111-1111-1111-1111-111111111111'::uuid,
        rm."MaterialId",
        CASE rm."Name"
        ...
        END,
        CASE rm."Name"
            WHEN 'Columbus' THEN 'Boil'
            WHEN 'Centennial' THEN 'Boil'
            WHEN 'Cascade' THEN 'Dry Hop'
        END,
        CASE rm."Name"
    ...
    INSERT INTO "RecipeYeast" ("RecipeId", "MaterialId", "Amount", "Unit", "SortOrder")
    SELECT
        '11111111-1111-1111-1111-111111111111'::uuid,
        rm."MaterialId",
        1,
